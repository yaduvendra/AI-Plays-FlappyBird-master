...
Game.prototype = 
{
    ...
    updateGame: function ()
    {
        ...
        if (!this._aliveNum && !this.gameover)
        {
            ...
            setTimeout(function (){clearInterval(timer); self.generation.nextGeneration(); self.initGame();}, dashboard.getSimSpeed()*70);
            this.gameover = true;
        }
    ...
    setTimer: function ()
    {
        ...
        timer = setInterval(function (){self.updateGame();}, dashboard.getSimSpeed());
    }
}
